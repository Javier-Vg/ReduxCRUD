...
const Updateuser = () => {
  ...
  const userobj = useSelector((state) => state.user.userobj); //useSELECTOR  se usa para acceder a los estados globales de redux

  const handlesubmit = (e) => {
    //e.preventDefault();
    const userobj = { id, name, email, phone, role }; //valores de los state
